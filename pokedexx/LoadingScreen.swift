...
class LoadingScreen: UIViewController,NVActivityIndicatorViewable {
    ...
    var texts = ["Applying Super Repel", "Waking Snorlax", "Seeking Seaking", "Charging Pikachu", "Hatching Eggs","Using Escape Rope", "Buying Pokéballs", "Untangling Tangela" ,"Loading Pokédex"]
    var timer : Timer?
